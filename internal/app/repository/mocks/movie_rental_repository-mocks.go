...
func (m *MockRepository) AddMovieToCart(custId, movieId int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddMovieToCart", custId, movieId)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddMovieToCart indicates an expected call of AddMovieToCart.
func (mr *MockRepositoryMockRecorder) AddMovieToCart(custId, movieId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddMovieToCart", reflect.TypeOf((*MockRepository)(nil).AddMovieToCart), custId, movieId)
}
